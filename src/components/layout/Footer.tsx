          ...
          <Row>
            ...
            <Col md={6} sm={24} xs={24}>
              <div className="footer-center">
                ...
                <div>
                  <a target="_blank" rel="noopener noreferrer" href="http://zhuanlan.zhihu.com/">
            ...
            <Col md={6} sm={24} xs={24}>
              <div className="footer-center">
                ...
                <div>
                  <a target="_blank " href="https://github.com/olddriversclub/olddrivers">
                    GitHub
                  </a>
                </div>
                <div>
                ...
                <div>
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/olddriversclub/olddrivers/wiki/FAQ"
                  >
                ...
                <div>
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/olddriversclub/olddrivers/issues"
                  >
                ...
                <div>
                  <a target="_blank" rel="noopener noreferrer" href="https://segmentfault.com/">
